...
四篇文章不但描述了一个软件的开发，也记录了我的一段经历。通过对企业价值的分析，尤其是准备买入之前，对上市公司不再是盲目的猜测了，而是有了一个相对客观的标尺对其价值进行衡量。当然，过去的财务报表只能代表企业的过去，企业的价值还体现在其未来的赚钱能力上，因此任何基于历史数据的预测都难免有主观片面的问题。再加上 DCF 模型本身很多参数需要假设，因此真要运用于实际买卖操作时，还需要有比较大的“安全边际”才可以。
