...
1. 基准收益率 rf：即市场长期无风险收益率，在这里以 30 年期国债收益率来代替，目前为 3.3%。 [数据来源](http://yield.chinabond.com.cn/cbweb-mn/yield_main)
2. 普通股的期望收益率：
   $$ E(r) = rf + beta*(rm - rf) $$
   - beta : 股票的 beta 值
   - rm ： 市场期望回报率 用 A 股过去 5 年的平均涨幅来计算。得出平均市场回报为 6.6%
3.
