...
作为一名理工 IT 男，后来又读了一个金融类的 MBA，那么利用计算机来解决金融方面的问题算是对“学以致用”这个词最好的注解了。该系列文章是我通过用 Python 对上市公司的企业价值分析的软件开发过程的一个整理与回顾，计划写四篇，本文是第一篇，用 Python 获取企业年报数据，获取上市公司的定期报告，为后续的企业价值分析提供数据，讲述如何用 Python 从巨潮网站下载相应的定期财务报告。
